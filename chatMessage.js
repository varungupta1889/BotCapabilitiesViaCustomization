...
const CUSTOMCASEFORM_MESSAGE_PREFIX = 'CUSTOM_CASE_FORM';
const SUPPORTED_MESSAGE_PREFIX = [DEFAULT_MESSAGE_PREFIX, CUSTOMCASEFORM_MESSAGE_PREFIX, RICHTEXT_MESSAGE_PREFIX, YOUTUBE_MESSAGE_PREFIX, IMAGE_MESSAGE_PREFIX, URL_MESSAGE_PREFIX, NAVIGATE_MESSAGE_PREFIX];
...
export default class ChatMessageDefaultUI extends BaseChatMessage {
    ...
    get isCustomCaseForm() {
        return this.messageType === CUSTOMCASEFORM_MESSAGE_PREFIX;
    }
